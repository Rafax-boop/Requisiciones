...
namespace Inventario.AplicacionWeb.Models.ViewModels
{
    public class VMTablaRequisiciones
    {
        ...
        public List<VMRequisicionMaestra> RequisicionesAutorizadas { get; set; } = new();
        public List<ConsolidadaDTO> ConsolidadasAutorizadas { get; set; } = new();
        public List<VMRequisicionMaestra> RequisicionesRechazadas { get; set; } = new();
        public List<ConsolidadaDTO> ConsolidadasRechazadas { get; set; } = new();
